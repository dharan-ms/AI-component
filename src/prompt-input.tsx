      ...
      <div className="px-4 py-3 border-b border-gray-800">
        ...
        <div className="flex flex-wrap gap-1.5">
          <input
            ...
            placeholder="sk-..."
            className="flex-1 min-w-0 basis-[min(100%,8rem)] bg-gray-800 border border-gray-700 rounded-lg px-2.5 py-1.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-violet-500"
          />
          <button
            type="button"
          ...
          <button
            ...
            className="px-2.5 py-1.5 text-xs text-gray-400 bg-gray-800 border border-gray-700 rounded-lg hover:text-red-300 hover:border-red-900/50 transition-colors"
          >
            Clear
          </button>
        </div>
